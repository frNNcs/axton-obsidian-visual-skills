...
> **Note:** This file was originally the Chinese documentation and has been translated to English.
...
| Type | Use Case |
|------|---------|
| **Flowchart** | Step-by-step instructions, workflows, task execution sequences |
...
**Trigger words:**
- Obsidian: `Excalidraw`, `draw diagram`, `flowchart`, `mind map`
